...
######################################################################
for MACS_OUTPUT_FILE in ${OUTPUT_DIR}/${ID}/peak_calls/*{broadPeak,gappedPeak}
do
...
$HOMER/bin/mergePeaks -d $DISTANCE \
                      ${ID}.hg38_peaks.broadPeak.filtered.bed \
                      ${ID}.personalized_peaks.broadPeak.filtered.bed \
...
$HOMER/bin/mergePeaks -d $DISTANCE \
                      ${ID}.hg38_peaks.broadPeak.filtered.bed \
                      ${ID}.wasp_peaks.broadPeak.filtered.bed \
...
echo "Done with $(basename ${OUTPUT_DIR})/${ID} Stage 3: BroadPeak Calling"
