...
Read in VCFs
```{r}
files_anxa1_edit_batch_2       <- list.files("roi_alignments/output/batch_2/alignments", pattern = "*.dedup.bam$", full.names = TRUE)
files_anxa1_edit_batch_2_names <-

# Loop through directory
for(i in seq_along(files_anxa1_edit_batch_2))
top_hits_mcf10a_batch_2 <- 
